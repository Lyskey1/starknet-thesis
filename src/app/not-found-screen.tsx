  ...
  { text: <>   Route  : <span id="nf-path" className="hi">/</span></>, delay: 1.3 },
  {
    text: (
      <>
        {"   Status : "}
        <h1 className="nf-h1">
          <span className="nf-sr">Page not found. </span>
          <span className="hi">404 None</span>
        </h1>
      </>
    ),
    delay: 1.45,
...
/* the status line is the page h1. display:inline and inherited type keep it
   pixel-identical to the span it replaced; only the semantics change. */
.nf .nf-h1{display:inline;margin:0;font:inherit;color:inherit;letter-spacing:inherit}
.nf .nf-sr{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0 0 0 0);white-space:nowrap;border:0}
