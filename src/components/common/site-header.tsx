...
export const SiteHeader = () => {
  return (
    <header className="pointer-events-auto fixed top-[0.694vw] left-1/2 z-50 h-[3.542vw] w-[60.5vw] max-w-[95vw] -translate-x-1/2 border border-white/10 bg-black/80 backdrop-blur-[8px] max-lg:top-[1rem] max-lg:h-[3.5rem] max-lg:w-[calc(100%-3rem)] max-sm:top-[0.75rem] max-sm:w-[calc(100%-2.5rem)]">
      <div className="flex h-full items-center justify-between py-[0.556vw] pr-[0.556vw] pl-[0.833vw] max-lg:py-[0.5rem] max-lg:pr-[0.5rem] max-lg:pl-[1rem]">
        <PressableLink
          ...
          interaction={QUIET}
          className="block h-[1.806vw] w-[13.9vw] shrink-0 max-lg:h-[1.5rem] max-lg:w-[11.5rem]"
        >
